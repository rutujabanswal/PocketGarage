...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        else if (id == R.id.nav_garage_near_me) {
            // Handle the camera action
            Toast.makeText(getApplicationContext(),"Garage Fragment Selected",Toast.LENGTH_SHORT).show();
            findGarageNearMe findGarageNearMe = new findGarageNearMe();
            FragmentManager fragmentManager = getFragmentManager();
            fragmentManager.beginTransaction().replace(R.id.frameLayoutMain,findGarageNearMe).commit();
        }
        else if (id == R.id.nav_find_nearby_garage) {
            // Handle the camera action
            Toast.makeText(getApplicationContext(),"Garage new Fragment Selected",Toast.LENGTH_SHORT).show();
